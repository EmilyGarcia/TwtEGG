...
**TwtEGG** is a basic twitter app to read and compose tweets the [Twitter API](https://apps.twitter.com/).
...
1. how to make certain shapes e.g. make profile a square or circle
2. preffered spacing between rows

## Video Walkthrough

Here's a walkthrough of implemented user stories:

<img src='https://github.com/EmilyGarcia/TwtEGG/blob/master/twt.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />

GIF created with [LiceCap](http://www.cockos.com/licecap/).

## Notes

One challenge I had while working on this app was getting the unretweet functionality because I was accidently using the wrong endpoint.
...
<img src='https://github.com/EmilyGarcia/TwtEGG/blob/master/twt2.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />

GIF created with [LiceCap](http://www.cockos.com/licecap/).

## Notes

One of the greatest challenges for this project was using the placeholder pod.
